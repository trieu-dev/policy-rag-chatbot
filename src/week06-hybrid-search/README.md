...
| Thu | `feat(week06): add OllamaReranker` | Rerank top-20 results to top-5 using local LLM |
| Fri | `feat(week06): add query rewriting with HyDE (Ollama)` | Generate hypothetical answer with Ollama → embed → search |
